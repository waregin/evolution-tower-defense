...
const EXTINCTION = buildMode("extinction", [
  {
    theme: "Claws", traits: SURV_TRAITS, examples: ["darwinFinch", "cepaea", "soapberryBug", "deerMouseSandHills", "whiteSandsLizard"],
  ...
  {
    theme: "Venom", traits: SURV_TRAITS, examples: ["warfarinRat", "ecoliLTEE", "btResistance", "glyphosateWeed", "malariaResistance"],
  ...
  {
    theme: "The Hunter's Eye", traits: SURV_TRAITS, examples: ["pepperedMoth", "pocketMouse", "beachMouse", "snowshoeHare", "kingsnakeMimicry"],
  ...
  {
    theme: "Full Arsenal", traits: SURV_TRAITS, examples: ["guppy", "honeycreeper", "cuckooHost", "crossbill", "daphniaDefense"],
  ...
  {
    theme: "Arms-Race Gauntlet", traits: SURV_TRAITS, examples: ["whale", "tiktaalik", "hyena", "echolocationConvergence", "tibetanAltitude"],
  ...
  {
    theme: "Scarcity", traits: SURV_TRAITS, examples: ["cavefish", "horse", "kiwiWing", "olm", "vitaminCLoss"],
...
const SURVIVAL = buildMode("survival", [
  {
    theme: "Breed for Green", traits: SURV_TRAITS, examples: ["pocketMouse", "pepperedMoth", "beachMouse", "cepaea", "soaySheep"],
  ...
  {
    theme: "Build a Tank", traits: SURV_TRAITS, examples: ["warfarinRat", "stickleback", "newtSnake", "myxoma", "btResistance"],
  ...
  {
    theme: "Forge Armor", traits: SURV_TRAITS, examples: ["darwinFinch", "redDeer", "daphniaDefense", "crossbill", "anolis"],
  ...
  {
    theme: "Designer Colors", traits: SURV_TRAITS, examples: ["cichlid", "timema", "heliconius", "whiteSandsLizard", "snowshoeHare"],
  ...
  {
    theme: "Conservation", traits: SURV_TRAITS, examples: ["elephant", "condor", "cheetah", "mauritiusKestrel", "floridaPanther"],
  ...
  {
    theme: "Use It or Lose It", traits: SURV_TRAITS, examples: ["cavefish", "horse", "stickleback", "nakedMoleRat", "flightlessCormorant"],
...
const SEXUAL = buildMode("sexual", [
  {
    theme: "Runaway", traits: SEX_TRAITS, examples: ["widowbird", "stalkEyedFly", "peacock", "birdOfParadise", "sageGrouse"],
  ...
  {
    theme: "Curb the Display", traits: SEX_TRAITS, examples: ["guppy", "tungaraFrog", "flatwingCricket", "barnSwallow", "swordtailSword"],
  ...
  {
    theme: "The Handicap Balance", traits: SEX_TRAITS, examples: ["redDeer", "dungBeetleHorns", "peacock", "barnSwallow", "widowbird"],
  ...
  {
    theme: "Strong Preference", traits: SEX_TRAITS, examples: ["cichlid", "satinBowerbird", "stalkEyedFly", "birdOfParadise", "sageGrouse"],
  ...
  {
    theme: "Coevolution Gauntlet", traits: SEX_TRAITS, examples: ["guppy", "tungaraFrog", "widowbird", "swordtailSword", "flatwingCricket"],
  ...
  {
    theme: "The Cost of Beauty", traits: SEX_TRAITS, examples: ["redDeer", "dungBeetleHorns", "tungaraFrog", "barnSwallow", "satinBowerbird"],
...
const DRIFT = buildMode("drift", [
  {
    theme: "Lucky Few", traits: DRIFT_TRAITS, examples: ["cheetah", "elephantSeal", "condor", "przewalskiHorse", "amishEvc"],
  ...
  {
    theme: "Bottleneck", traits: DRIFT_TRAITS, examples: ["elephantSeal", "pingelap", "mauritiusKestrel", "floridaPanther", "przewalskiHorse"],
  ...
  {
    theme: "Refuge", traits: DRIFT_TRAITS, examples: ["condor", "cheetah", "mauritiusKestrel", "floridaPanther", "pingelap"],
...
const SPECIATION = buildMode("speciation", [
  {
    theme: "Disruptive Selection", traits: SPEC_TRAITS, examples: ["rhagoletis", "cichlid", "heliconius", "timema", "sticklebackPair"],
  ...
  {
    theme: "Reproductive Isolation", traits: SPEC_TRAITS, examples: ["rhagoletis", "undergroundMosquito", "mimulus", "howeaPalm", "darwinFinch"],
  ...
  {
    theme: "Two Species", traits: SPEC_TRAITS, examples: ["cichlid", "greenishWarbler", "heliconius", "sticklebackPair", "anolis"],
